 ...
 *
 * 프레임이 여백까지 온전히 들어가는 폭(430+32)이면 바로 프레임을 씌운다.
 * 예전엔 640으로 잡아 뒀는데, 그 사이 구간(폴더블·태블릿 분할화면·좁힌 브라우저 창)에서
 * 430 기준으로 만든 화면이 전체 폭으로 늘어나 카드·케어현황 링·탭바가 벌어져 보였다.
 */
const DESKTOP_MIN_WIDTH = FRAME_WIDTH + GUTTER;
